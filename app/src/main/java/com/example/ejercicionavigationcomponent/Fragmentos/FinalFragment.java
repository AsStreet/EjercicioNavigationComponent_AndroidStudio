...
public class FinalFragment extends Fragment implements View.OnClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        texto = view.findViewById(R.id.idTXTextoFragmentFinal);
        boton = view.findViewById(R.id.idBTCambiarFragmentFinal);
    ...
    public void onClick(View v) {
        ...
        navegador.navigate(R.id.action_finalFragment_to_inicioFragment);
    }
}